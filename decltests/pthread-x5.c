...
void f(void)
{
  ...
  int
    ...
    ye = PTHREAD_CREATE_DETACHED,
    yf = PTHREAD_CREATE_JOINABLE,
    yg = PTHREAD_EXPLICIT_SCHED,
    yh = PTHREAD_INHERIT_SCHED,
    yi = PTHREAD_MUTEX_DEFAULT,
    yj = PTHREAD_MUTEX_ERRORCHECK,
    yk = PTHREAD_MUTEX_NORMAL,
    yl = PTHREAD_MUTEX_RECURSIVE,
    ym = PTHREAD_PRIO_INHERIT,
    yn = PTHREAD_PRIO_NONE,
    yo = PTHREAD_PRIO_PROTECT,
    yp = PTHREAD_PROCESS_SHARED,
    yq = PTHREAD_PROCESS_PRIVATE,
    yr = PTHREAD_SCOPE_PROCESS,
    ys = PTHREAD_SCOPE_SYSTEM;
  void *
    yt = PTHREAD_CANCELED;
